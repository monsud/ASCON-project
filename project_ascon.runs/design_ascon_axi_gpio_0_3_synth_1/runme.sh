...
HD_PWD='C:/Users/david/Documents/ASCON-project/project_ascon.runs/design_ascon_axi_gpio_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ascon_axi_gpio_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ascon_axi_gpio_0_3.tcl
